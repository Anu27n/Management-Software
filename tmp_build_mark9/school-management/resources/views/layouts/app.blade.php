...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        @if($canManageStudents)
            ...
            <a href="{{ route('students.index') }}" class="nav-link {{ request()->routeIs('students.index','students.show','students.edit','students.bulk-upload','students.bulk-upload.store','students.bulk-upload.template') ? 'active' : '' }}">
    ...
    <nav class="bottom-nav" id="bottomNav">
        <div class="bottom-nav-inner">
            ...
            @if($canManageStudents)
                <a href="{{ route('students.index') }}" class="bottom-nav-item {{ request()->routeIs('students.index','students.show','students.edit','students.bulk-upload','students.bulk-upload.store','students.bulk-upload.template') ? 'active' : '' }}">
                    <i class="bi {{ request()->routeIs('students.index','students.show','students.edit','students.bulk-upload','students.bulk-upload.store','students.bulk-upload.template') ? 'bi-people-fill' : 'bi-people' }}"></i>
                    <span>Students</span>
                </a>
            @endif
    ...
    <div class="more-menu" id="moreMenu">
        ...
        <a href="{{ route('students.index') }}" class="more-menu-item {{ request()->routeIs('students.index','students.show','students.edit','students.bulk-upload','students.bulk-upload.store','students.bulk-upload.template') ? 'active' : '' }}">
            <i class="bi bi-people-fill"></i> Students
        </a>
        @endif
        @if($canManageAttendance)
