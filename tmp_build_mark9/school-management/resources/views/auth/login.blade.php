...
<body>
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('login.submit') }}">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="login" class="form-control" value="{{ old('login') }}" placeholder="admin@school.com or admin" required autofocus>
                </div>
            </div>
            <div class="mb-3">
        ...
        <div class="text-center mt-3">
            ...
            <small class="text-muted">Teacher, parent, and student-linked logins can sign in using either email or username.</small>
        </div>
    </div>
</body>
</html>
