    ...
    <div class="card-body">
        <form method="POST" action="{{ route('students.store') }}" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-4">
                <div class="col-12">
                    <div class="alert alert-info mb-0">
                        This form now creates or reuses the linked parent login automatically from the contact email and phone entered above. If the email already exists as a parent account, the same login will be reused.
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i>Create Admission</button>
