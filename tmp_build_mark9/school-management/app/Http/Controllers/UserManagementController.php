...
class UserManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($hasUsernameColumn) {
            $userData['username'] = UserCredentialSupport::generateUniqueUsername($validated['username'] ?? $validated['email']);
        }
    ...
    public function update(Request $request, User $user)
    {
        ...
        if ($hasUsernameColumn) {
            $updateData['username'] = UserCredentialSupport::generateUniqueUsername($validated['username'] ?? $validated['email'], $user->id);
        }
