...
<div class="installer-card">
    ...
    <div class="installer-body">
        ...
        <div class="alert alert-info small mb-3">
            <strong>Hostinger / cPanel:</strong> Use <strong>Host = localhost</strong> (not 127.0.0.1). Copy the exact database name, username and password from your hosting panel (e.g. hPanel → Databases → MySQL).
        </div>
        <form method="POST">
