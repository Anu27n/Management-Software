    ...
    <div class="card-body">
        <form method="POST" action="{{ route('students.update', $student) }}" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-3">
                    <label class="form-label">Primary Contact Email <span class="text-danger">*</span></label>
            ...
            <div class="row g-3 mb-4">
                <div class="col-12">
                    <div class="alert alert-info mb-0">
                        Editing the contact email updates the linked parent login automatically. Existing passwords are kept unless a new parent account has to be created.
                        @if($student->parentUser)
                            Current login: <strong>{{ $student->parentUser->username ?: $student->parentUser->email }}</strong>
                        @endif
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i>Update Admission</button>
