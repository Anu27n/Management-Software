...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('students.promote') }}" class="btn btn-outline-secondary"><i class="bi bi-arrow-up-circle me-1"></i>Promote Students</a>
        ...
        <a href="{{ route('students.create') }}" class="btn btn-primary"><i class="bi bi-lightning-charge-fill me-1"></i>Quick Admission</a>
    </div>
</div>
...
@if(session('generated_credentials'))
    ...
    <div class="alert alert-warning">
        <div class="fw-semibold mb-1">New login credentials</div>
