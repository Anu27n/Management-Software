...
@section('content')
@php($dashboardType = $dashboardType ?? 'admin')
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-lg-3">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="text-muted small">Assigned Classes</div>
                    <div class="fs-4 fw-bold">{{ $assignedClasses->count() }}</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="text-muted small">Assigned Students</div>
        ...
        <div class="col-lg-7">
            <div class="card table-card">
                <div class="card-header bg-white">
                    <h6 class="mb-0 fw-semibold">Recent Homework</h6>
                </div>
                <div class="card-body p-0">
                    @forelse($recentHomework as $homework)
                        <div class="list-group-item border-0 border-bottom">
                            <div class="fw-semibold">{{ $homework->title }}</div>
                            <small class="text-muted">{{ $homework->schoolClass?->name }} {{ $homework->section?->name ? '- ' . $homework->section->name : '' }}</small>
                        </div>
                    @empty
                        <div class="text-center py-4 text-muted">No homework assigned yet.</div>
                    @endforelse
                </div>
            </div>
        </div>
...
@elseif($dashboardType === 'cashier')
    <div class="row g-3 mb-4">
        <div class="col-6 col-lg-3">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="text-muted small">Payments Today</div>
                    <div class="fs-4 fw-bold">{{ $paymentsTodayCount }}</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="card stat-card">
                <div class="card-body">
                    ...
                    <div class="fs-4 fw-bold">Rs {{ number_format($paymentsTodayAmount, 2) }}</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
        ...
        <div class="col-6 col-lg-3">
            <div class="card stat-card">
                <div class="card-body">
                    ...
                    <div class="fs-4 fw-bold">{{ $partialPayments }}</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-end mb-3">
        <a href="{{ route('fees.payments.create') }}" class="btn btn-primary">
            <i class="bi bi-lightning-charge me-1"></i>Quick Record Payment
        </a>
    </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-lg-4">
            <div class="card table-card">
                <div class="card-header bg-white">
                    <h6 class="mb-0 fw-semibold">Notices</h6>
                </div>
                <div class="card-body p-0">
                    @forelse($recentNotices as $notice)
                        <a href="{{ route('notices.show', $notice) }}" class="list-group-item list-group-item-action">
...
@elseif(in_array($dashboardType, ['parent', 'student'], true))
    <div class="row g-3 mb-4">
        <div class="col-6 col-lg-3">
            <div class="card stat-card">
                <div class="card-body">
        ...
        <div class="col-6 col-lg-3">
            <div class="card stat-card">
                <div class="card-body">
                    ...
                    <div class="fs-4 fw-bold">Rs {{ number_format($dueAmount, 2) }}</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="text-muted small">Due Fee Heads</div>
                    <div class="fs-4 fw-bold">{{ $dueItemsCount }}</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
    ...
    <div class="row g-3">
        <div class="col-lg-7">
            <div class="card table-card">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h6 class="mb-0 fw-semibold">Recent Payments</h6>
                    <a href="{{ route('fees.my-fees') }}" class="btn btn-sm btn-outline-primary">Fees & Payments</a>
                </div>
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        <thead class="table-light">
        ...
        <div class="col-lg-5">
            ...
            <div class="card table-card">
                <div class="card-header bg-white">
                    <h6 class="mb-0 fw-semibold">Quick Summary</h6>
                </div>
                <div class="card-body">
                    <div class="d-flex justify-content-between py-2 border-bottom">
                        <span class="text-muted">Pending Leaves</span>
                        <span class="fw-semibold">{{ $pendingLeaves }}</span>
                    </div>
                    <div class="d-flex justify-content-between py-2 border-bottom">
                    ...
                    <div class="d-flex justify-content-between py-2">
                        <span class="text-muted">Fee Center</span>
                        <a href="{{ route('fees.my-fees') }}" class="fw-semibold text-decoration-none">Open</a>
                    </div>
                    <div class="d-flex justify-content-between py-2">
                        <span class="text-muted">Attendance</span>
                        <a href="{{ route('attendance.my-attendance') }}" class="fw-semibold text-decoration-none">View</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            @foreach($recentPayments as $payment)
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <small class="text-success fw-bold">Rs {{ number_format($payment->amount_paid) }}</small>
                                    </div>
