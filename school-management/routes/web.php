...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/homework/{homework}/attachment', [HomeworkController::class, 'downloadAttachment'])
        ->whereNumber('homework')
        ->middleware('permission:homework.view')
        ->name('homework.attachment.download');
    Route::post('/homework/{homework}/submit', [HomeworkController::class, 'submit'])
        ->whereNumber('homework')
        ->middleware('permission:homework.view')
        ->name('homework.submit');
    Route::get('/homework-submissions/{submission}/attachment', [HomeworkController::class, 'downloadSubmissionAttachment'])
        ->whereNumber('submission')
        ->middleware('permission:homework.view')
        ->name('homework.submissions.attachment.download');
    ...
    Route::post('/fees/my-fees/razorpay/order', [FeeController::class, 'createMyRazorpayOrder'])->name('fees.my-fees.razorpay.order');
    Route::post('/fees/my-fees/pay-online', [FeeController::class, 'storeMyOnlinePayment'])->name('fees.my-fees.pay-online');
    Route::post('/api/fees/razorpay/verify', [FeeController::class, 'verifyRazorpayPayment'])->name('api.fees.razorpay.verify');
    Route::get('/attendance/my-attendance', [AttendanceController::class, 'myAttendance'])->name('attendance.my-attendance');
    ...
    Route::middleware('permission:students.manage')->group(function () {
        ...
        Route::post('/students/promote', [StudentController::class, 'promoteStore'])->name('students.promote.store');
